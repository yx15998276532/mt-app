<template>
  <div class="page-register">
      ...
      <div class="content">
        ...
        <el-form-item>
        <el-button type="primary" @click="submitForm('registerForm')">提交/注册</el-button>
...
export default {
  ...
  methods: {
    ...
    input () {
      ...
      var regNum = /(\d)+/g
      var reg = /_/g
      var strongth = this.registerForm.password.match(reg) && this.registerForm.password.match(regStr) &&
