   ...
   <footer class="com-footer">
      <div class="footer-content">
          <div class="footer-link clearfix">
            ...
            <dl>
              <dt>用户帮助</dt>
                <dd><a href="http://www.meituan.com/about/selfservice" target="_blank"></a>申请退款</dd>
                <dd><a href="http://www.meituan.com/about/terms" target="_blank"></a>用户协议</dd>
                <dd><a href="http://www.meituan.com/about/faq" target="_blank"></a>常见问题</dd>
                <dd><a href="http://www.meituan.com/about/privacy" target="_blank"></a>隐私设置</dd>
                <dd><a href="http://www.meituan.com/about/anticheat" target="_blank"></a>防诈骗公告</dd>
                <dd> <a href="https://rules-center.meituan.com/customer-rights" target="_blank"></a>消费者权益保障</dd>
          </dl>
          <dl>
            <dt>美团服务</dt>
              <dd>
      ...
      <div class="footer-column">
          <dl>
              <dt>消费者服务热线</dt>
               <dd>外卖消费者:
                   <a rel="nofollow" href="rel:10109777">10109777</a>
                   </dd>
               <dd>猫眼消费者：
